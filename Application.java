...
public class Application {
	public static void main(String[] args){
		...
		TextFileIO.loadMountainData("mountains.txt", myDisk, 1000, 60, 27, 27);
		TextFileIO.buildIndexTree(myDisk, 27, 1000, 7);
		IndexedFile myIndexFile = new IndexedFile(myDisk, 60, 27, 34, 1000,TextFileIO.getIndexStart(),TextFileIO.getIndexSectors(),TextFileIO.getIndexRoot(),TextFileIO.getIndexLevels());
/*
		...
		while(notDone)
		{
			...
			case 1:
				...
				record = TextFileIO.formatRecord(name, 27, country, 27, altitude, 6);//Format a 60 character record with data
			...
			case 2:
				...
				System.out.println("Name: ");									//Get record data
				name = keyboard.nextLine();
				record = TextFileIO.formatRecord(name, 27, "", 27, "", 6); //Format a 60 character record with key
